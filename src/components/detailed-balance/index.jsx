  ...
  return (
    <div className="w-full p-4 overflow-x-auto rounded-md shadow-lg scroll bg-zinc-300">
      ...
      <Link
        ...
        className="flex self-end gap-3 p-2 mb-2 ml-auto mr-5 text-black transition-all duration-300 border rounded-md hover:border-green-800 max-w-max hover:text-green-800 border-zinc-900"
      >
